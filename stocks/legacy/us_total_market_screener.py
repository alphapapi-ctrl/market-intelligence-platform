...
from config.screener.study_us_total_market import config
...
def save_results(df, results_dir, study_name):
    ...
    # Save per sector
    sector_dir = f"results/screener/us_sectors/"
